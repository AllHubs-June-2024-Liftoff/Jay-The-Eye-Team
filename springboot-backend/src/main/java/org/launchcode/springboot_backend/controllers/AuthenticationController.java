...
import org.launchcode.springboot_backend.models.dto.LoginFormDTO;
import org.launchcode.springboot_backend.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO,
        ...
        if (theUser == null) {
            errors.rejectValue("username", "user.invalid", "The submitted username does not exist");
            model.addAttribute("title", "Log in");
            return "login";
        }
